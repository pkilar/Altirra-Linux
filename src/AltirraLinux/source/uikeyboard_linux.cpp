...
// Linux port of uikeyboard.cpp — keyboard mapping tables and functions.
// The mapping tables are identical to the Windows version. VK_ constants
// are defined as their ATInputCode equivalents since ATInputCode values
// are numerically identical to Windows virtual key codes.
...
///////////////////////////////////////////////////////////////////////////
// VK_ compatibility defines — map Windows virtual key codes to their
// ATInputCode equivalents (which use the same numeric values).
///////////////////////////////////////////////////////////////////////////

#include "inputdefs.h"

#define VK_BACK         kATInputCode_KeyBack        // 0x08
#define VK_TAB          kATInputCode_KeyTab         // 0x09
#define VK_RETURN       kATInputCode_KeyReturn      // 0x0D
#define VK_ESCAPE       kATInputCode_KeyEscape      // 0x1B
#define VK_SPACE        kATInputCode_KeySpace       // 0x20
#define VK_PRIOR        kATInputCode_KeyPrior       // 0x21
#define VK_NEXT         kATInputCode_KeyNext        // 0x22
#define VK_END          kATInputCode_KeyEnd         // 0x23
#define VK_HOME         kATInputCode_KeyHome        // 0x24
#define VK_LEFT         kATInputCode_KeyLeft        // 0x25
#define VK_UP           kATInputCode_KeyUp          // 0x26
#define VK_RIGHT        kATInputCode_KeyRight       // 0x27
#define VK_DOWN         kATInputCode_KeyDown        // 0x28
#define VK_INSERT       kATInputCode_KeyInsert      // 0x2D
#define VK_DELETE       kATInputCode_KeyDelete      // 0x2E
#define VK_F1           kATInputCode_KeyF1          // 0x70
#define VK_F2           kATInputCode_KeyF2          // 0x71
#define VK_F3           kATInputCode_KeyF3          // 0x72
#define VK_F4           kATInputCode_KeyF4          // 0x73
#define VK_F5           kATInputCode_KeyF5          // 0x74
#define VK_F6           kATInputCode_KeyF6          // 0x75
#define VK_F7           kATInputCode_KeyF7          // 0x76
#define VK_F8           kATInputCode_KeyF8          // 0x77
#define VK_F9           kATInputCode_KeyF9          // 0x78
#define VK_F10          kATInputCode_KeyF10         // 0x79
#define VK_F11          kATInputCode_KeyF11         // 0x7A
#define VK_F12          kATInputCode_KeyF12         // 0x7B
#define VK_OEM_1        kATInputCode_KeyOem1        // 0xBA  ;:
#define VK_OEM_PLUS     kATInputCode_KeyOemPlus     // 0xBB  =+
#define VK_OEM_COMMA    kATInputCode_KeyOemComma    // 0xBC  ,<
#define VK_OEM_MINUS    kATInputCode_KeyOemMinus    // 0xBD  -_
#define VK_OEM_PERIOD   kATInputCode_KeyOemPeriod   // 0xBE  .>
#define VK_OEM_2        kATInputCode_KeyOem2        // 0xBF  /?
#define VK_OEM_3        kATInputCode_KeyOem3        // 0xC0  `~
#define VK_OEM_4        kATInputCode_KeyOem4        // 0xDB  [{
#define VK_OEM_5        kATInputCode_KeyOem5        // 0xDC  \|
#define VK_OEM_6        kATInputCode_KeyOem6        // 0xDD  ]}
#define VK_OEM_7        kATInputCode_KeyOem7        // 0xDE  '"

// Keys without ATInputCode equivalents — use Windows VK values directly
...
///////////////////////////////////////////////////////////////////////////
// Character-to-scan-code mapping table (from uikeyboard.cpp)
///////////////////////////////////////////////////////////////////////////
...
static constexpr uint8 kATUIDefaultCharToScanCodeMappings[][2] {
	...
	{ 0x00F9, 0xBF },	// latin small letter U with grave
	{ 0x00D1, 0x95 },	// latin capital letter N with tilde
	{ 0x00C9, 0x92 },	// latin capital letter E with acute
	{ 0x00E7, 0xBA },	// latin small letter C with cedilla
	{ 0x00F4, 0xAA },	// latin small letter O with circumflex
	{ 0x00F2, 0xB8 },	// latin small letter O with grave
	{ 0x00EC, 0xBD },	// latin small letter I with grave
	{ 0x00A3, 0xB9 },	// pound sign
	{ 0x00EF, 0x8D },	// latin small letter I with diaeresis
	{ 0x00FC, 0x81 },	// latin small letter U with diaeresis
	{ 0x00E4, 0x85 },	// latin small letter A with diaeresis
	{ 0x00D6, 0x80 },	// latin capital letter O with diaeresis
	{ 0x00FA, 0xA5 },	// latin small letter U with acute
	{ 0x00F3, 0xA3 },	// latin small letter O with acute
	{ 0x00F6, 0x88 },	// latin small letter O with diaeresis
	{ 0x00DC, 0x8A },	// latin capital letter U with diaeresis
	{ 0x00E2, 0xAF },	// latin small letter A with circumflex
	{ 0x00FB, 0xA8 },	// latin small letter U with circumflex
	{ 0x00EE, 0xBE },	// latin small letter I with circumflex
	{ 0x00E9, 0xAD },	// latin small letter E with acute
	{ 0x00E8, 0x8B },	// latin small letter E with grave
	{ 0x00F1, 0x90 },	// latin small letter N with tilde
	{ 0x00EA, 0xAE },	// latin small letter E with circumflex
	{ 0x00E5, 0x96 },	// latin small letter A with ring above
	{ 0x00E0, 0xAB },	// latin small letter A with grave
	{ 0x00C5, 0x97 },	// latin capital letter A with ring above

	{ 0x00A1, 0xA2 },	// inverted exclamation mark
	{ 0x00C4, 0x82 },	// latin capital letter A with diaeresis
};
...
static constexpr ATUIDefaultCharMappings kATUIDefaultCharMappings;

static void ATUIAddDefaultCharMappings(vdfastvector<uint32>& dst) {
...
static const vdfastvector<uint32>& ATUIGetCurrentKeyMap() {
...
bool ATUIGetDefaultScanCodeForCharacter(uint32 c32, uint8& ch) {
	...
	switch(c32) {
		case 0x2665: ch = 0xA0; return true;	// heart
		case 0x251C: ch = 0xBF; return true;	// vertical tee right
		case 0x2595: ch = 0x95; return true;	// vertical bar right
		case 0x2518: ch = 0x92; return true;	// top-left elbow
		case 0x2524: ch = 0xBA; return true;	// vertical tee left
		case 0x2510: ch = 0xAA; return true;	// bottom-left elbow
		case 0x2571: ch = 0xB8; return true;	// forward diagonal
		case 0x2572: ch = 0xBD; return true;	// backwards diagonal
		case 0x25E2: ch = 0xB9; return true;	// lower right filled triangle
		case 0x2597: ch = 0x8D; return true;	// lower right quadrant
		case 0x25E3: ch = 0x81; return true;	// lower left filled triangle
		case 0x259D: ch = 0x85; return true;	// quadrant upper right
		case 0x2598: ch = 0x80; return true;	// quadrant upper left
		case 0x2594: ch = 0xA5; return true;	// top quarter
		case 0x2582: ch = 0xA3; return true;	// bottom quarter
		case 0x2596: ch = 0x88; return true;	// lower left quadrant

		case 0x2663: ch = 0x8A; return true;	// club
		case 0x250C: ch = 0xAF; return true;	// lower-right elbow
		case 0x2500: ch = 0xA8; return true;	// horizontal bar
		case 0x253C: ch = 0xBE; return true;	// four-way
		case 0x2022: ch = 0xAD; return true;	// filled circle
		case 0x2584: ch = 0x8B; return true;	// lower half
		case 0x258E: ch = 0x90; return true;	// left quarter
		case 0x252C: ch = 0xAE; return true;	// horizontal tee down
		case 0x2534: ch = 0x96; return true;	// horizontal tee up
		case 0x258C: ch = 0xAB; return true;	// left side
		case 0x2514: ch = 0x97; return true;	// top-right elbow
		case 0x241B: ch = 0x1C; return true;	// escape
		...
		case 0x2666: ch = 0x61; return true;	// black diamond suit

		case 0x2660: ch = 0x82; return true;	// spade
		case 0x21B0: ch = 0x76; return true;	// curved arrow up-left (Clear)
		case 0x25C0: ch = 0x34; return true;	// tall left arrow (Back)
		case 0x25B6: ch = 0x2C; return true;	// tall right arrow (Tab)
	}
...
///////////////////////////////////////////////////////////////////////////
// Virtual key mapping tables (from uikeyboard.cpp)
///////////////////////////////////////////////////////////////////////////
...
// Natural layout — host keyboard positions map to Atari key labels
static const uint32 g_ATDefaultVKeyMap[]={
	...
	VKEYMAP(VK_OEM_5, kCtrl + kShift,	0xDC),	// Ctrl+Shift+\|
	...
	VKEYMAP(VK_HOME,	0,				0x76),	// Home -> Clear
	VKEYMAP(VK_HOME,	kShift,			0x76),	// Shift+Home -> Clear
	VKEYMAP(VK_HOME,	kCtrl,			0xB6),	// Ctrl+Home
	...
	VKEYMAP(VK_INSERT,	kShift,			0x77),	// Shift+Insert -> Insert Line
...
// Raw layout — physical key positions map to Atari keyboard matrix
...
// Start/Select/Option mappings (F2/F3/F4)
...
// Break mappings (F7/Pause/Ctrl+Break)
...
// 1200XL function key mappings (F1-F4 → Atari F1-F4)
...
static void ATUIRegisterVirtualKeyMappings(vdfastvector<uint32>& dst, const uint32 *mappings, uint32 n) {
	while(n--) {
		...
		// Force extended flag for navigation cluster keys
...
void ATUIGetDefaultKeyMap(const ATUIKeyboardOptions& options, vdfastvector<uint32>& mappings) {
	...
	// Arrow keys with ctrl/shift mode
